...
<div style="width: 500px; margin-left: auto; margin-right: auto; margin-top: 100px;">
    ...
    <span>* Giriş bilgilerinizi yöneticiden alınız</span>
    <form action="/personel/giris" method="post">
        <div class="mb-3">
    ...
    <a href="/ogrenci/giris" class="btn btn-warning mt-5">Öğrenci Girişi</a>
